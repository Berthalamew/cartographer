...
void user_interface_controller_set_replicated_achievement(e_controller_index controller_index, int32 replicated_achievements);
...
wchar_t const* __cdecl user_interface_controller_get_player_profile_name(e_controller_index controller_index);
...
void user_interface_controller_switch_to_offline(e_controller_index controller_index);
...
bool __cdecl user_interface_controller_connected(e_controller_index controller_index);
...
bool __cdecl user_interface_controller_xbox_live_account_signed_in(e_controller_index controller_index);
void user_interface_controller_set_xbox_live_account(e_controller_index controller_index, XUID* account);
