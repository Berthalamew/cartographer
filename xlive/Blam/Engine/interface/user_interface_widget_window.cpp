...
void user_interface_register_screen_to_channel(c_screen_widget* new_screen, c_screen_parameters* parameters)
{
...
void c_screen_with_menu::initialize(c_screen_parameters* parameters)
{
