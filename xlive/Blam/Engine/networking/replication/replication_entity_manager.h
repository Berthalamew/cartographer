...
public:
	...
	virtual e_network_read_result read_creation_from_packet(int32 entity_index, e_simulation_entity_type* simulation_entity_type, uint32* out_update_mask, int32 a5, int32* block_count, s_replication_allocation_block* a7, c_bitstream* packet) = 0;
	...
	virtual bool write_update_to_packet(int32 entity_index, uint32 update_mask, void* telemetry_data, class c_bitstream* packet, int32 required_leave_space_bits, uint32* update_mask_written) = 0;
	virtual int32 read_update_from_packet(int32 entity_index, uint32* out_update_mask, int32 maximum_block_count, int32* block_count, s_replication_allocation_block* blocks, class c_bitstream* packet) = 0;
