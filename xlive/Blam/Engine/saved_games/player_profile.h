...
{
	_saved_game_profile_input_preference_bit_controller_look_inversion = 0,
...
enum e_saved_game_player_profile_flags
{
	_saved_game_player_profile_guest_bit= 0,
	_saved_game_player_profile_bit1,
	k_number_of_saved_game_player_profile_flags
};
...
{
	int32 valid_maybe;
	c_flags_no_init<e_saved_game_player_profile_flags, uint32, k_number_of_saved_game_player_profile_flags> flags;
	wchar_t name[32];
	int8 data[160];
